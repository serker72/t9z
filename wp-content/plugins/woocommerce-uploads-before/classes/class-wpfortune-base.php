...
class WPFortune_Base {
	...
	public $version;
	public $plugin_url;
    public $addon_parent_slug;

    /*
     * Perform update check on instantiaton of this class
     */

	public function __construct($settings_plugin_name, $settings_plugin_version, $settings_plugin_id, $settings_plugin_slug, $settings_plugin_dir, $settings_plugin_file, $settings_upgrade_url, $settings_renew_url, $settings_docs_url, $settings_support_url, $addon_parent_slug = null)
    {
        ...
        $this->addon_parent_slug = $addon_parent_slug;
    ...
    public function plugin_links($links)
    {
        ...
        if ($this->addon_parent_slug !== null && !empty($this->addon_parent_slug)) {
          $new['settings'] = '<a href="'.admin_url('admin.php?page='.$this->addon_parent_slug).'">'.__('Settings', $this->plugin_slug).'</a>';
        }
